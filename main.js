...
var author$project$Main$InvalidToken = function (a) {
	return {$: 'InvalidToken', a: a};
};
...
var author$project$Type$Account = function (acct) {
	return function (avatar) {
		return function (created_at) {
			return function (display_name) {
				return function (followers_count) {
					return function (following_count) {
						return function (header) {
							return function (id) {
								return function (locked) {
									return function (note) {
										return function (statuses_count) {
											return function (url) {
												return function (username) {
													return {acct: acct, avatar: avatar, created_at: created_at, display_name: display_name, followers_count: followers_count, following_count: following_count, header: header, id: id, locked: locked, note: note, statuses_count: statuses_count, url: url, username: username};
												};
											};
										};
									};
...
var author$project$Account$decoder = A3(
										...
										A3(
											...
											A3(
												...
												A3(
													...
													'acct',
													elm$json$Json$Decode$string,
													elm$json$Json$Decode$succeed(author$project$Type$Account))))))))))))));
...
var truqu$elm_oauth2$OAuth$tokenFromString = function (str) {
	...
	if (_n0.a === 'Bearer') {
		...
		return elm$core$Maybe$Just(
			truqu$elm_oauth2$OAuth$Bearer(t));
	} else {
		return elm$core$Maybe$Nothing;
	}
};
var author$project$Token$decoder = A2(
	elm$json$Json$Decode$andThen,
	function (str) {
		var _n0 = truqu$elm_oauth2$OAuth$tokenFromString(str);
		if (_n0.$ === 'Just') {
			var token = _n0.a;
			return elm$json$Json$Decode$succeed(token);
		} else {
			return elm$json$Json$Decode$fail('Unable to decode token');
		}
	},
	elm$json$Json$Decode$string);
var author$project$Type$Client = F3(
	function (instance, token, account) {
		return {account: account, instance: instance, token: token};
	});
var author$project$Main$clientDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'account',
	author$project$Account$decoder,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'token',
		author$project$Token$decoder,
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'instance',
			elm$json$Json$Decode$string,
			elm$json$Json$Decode$succeed(author$project$Type$Client))));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Main$clientListDecoder = elm$json$Json$Decode$list(author$project$Main$clientDecoder);
...
var author$project$Main$resumeClient = function (clients) {
	var _n0 = truqu$elm_base64$Base64$decode(clients);
	if (_n0.$ === 'Ok') {
		var clients_ = _n0.a;
		var _n1 = A2(elm$json$Json$Decode$decodeString, author$project$Main$clientListDecoder, clients_);
		if (_n1.$ === 'Ok') {
			var list = _n1.a;
			return elm$core$Result$Ok(
			...
			return elm$core$Result$Err(
				author$project$Main$InvalidToken('Unable to parse stored account and token'));
		}
	} else {
		return elm$core$Result$Err(
			author$project$Main$InvalidToken('Unable to decode stored account and token'));
	}
};
...
var author$project$Page$Home$Model = F5(
	function (title, key, timelineMode, client, timeline) {
		return {client: client, key: key, timeline: timeline, timelineMode: timelineMode, title: title};
	});
...
var author$project$Mastodon$Decoder$idDecoder = elm$json$Json$Decode$string;
var author$project$Mastodon$Decoder$accountDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'username',
	elm$json$Json$Decode$string,
	A3(
			...
			A3(
				...
				A3(
					...
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'id',
						author$project$Mastodon$Decoder$idDecoder,
						A3(
							NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
							'header',
							elm$json$Json$Decode$string,
										...
										A3(
											...
											A3(
												...
												A3(
													...
													elm$json$Json$Decode$string,
													elm$json$Json$Decode$succeed(author$project$Type$Account))))))))))))));
var author$project$Type$Application = F2(
...
var author$project$Mastodon$Decoder$applicationDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'website',
	...
	A3(
		...
		'name',
		elm$json$Json$Decode$string,
		elm$json$Json$Decode$succeed(author$project$Type$Application)));
var author$project$Type$Attachment = F6(
	function (id, type_, url, remote_url, preview_url, text_url) {
		return {id: id, preview_url: preview_url, remote_url: remote_url, text_url: text_url, type_: type_, url: url};
	});
var author$project$Mastodon$Decoder$attachmentDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'text_url',
	elm$json$Json$Decode$nullable(elm$json$Json$Decode$string),
	A3(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'id',
						author$project$Mastodon$Decoder$idDecoder,
						elm$json$Json$Decode$succeed(author$project$Type$Attachment)))))));
var author$project$Type$Mention = F4(
	function (id, url, username, acct) {
		return {acct: acct, id: id, url: url, username: username};
	});
var author$project$Mastodon$Decoder$mentionDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'acct',
	elm$json$Json$Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				author$project$Mastodon$Decoder$idDecoder,
				elm$json$Json$Decode$succeed(author$project$Type$Mention)))));
var author$project$Type$StatusId = function (a) {
	return {$: 'StatusId', a: a};
};
var author$project$Mastodon$Decoder$statusIdDecoder = A2(elm$json$Json$Decode$map, author$project$Type$StatusId, author$project$Mastodon$Decoder$idDecoder);
var author$project$Type$Tag = F2(
	function (name, url) {
		return {name: name, url: url};
	});
var author$project$Mastodon$Decoder$tagDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'url',
	elm$json$Json$Decode$string,
	A3(
		...
		'name',
		elm$json$Json$Decode$string,
		elm$json$Json$Decode$succeed(author$project$Type$Tag)));
var author$project$Type$Reblog = function (a) {
	return {$: 'Reblog', a: a};
};
var author$project$Type$Status = function (account) {
	return function (application) {
		return function (content) {
			return function (created_at) {
				return function (favourited) {
					return function (favourites_count) {
						return function (id) {
							return function (in_reply_to_account_id) {
								return function (in_reply_to_id) {
									return function (media_attachments) {
										return function (mentions) {
											return function (reblog) {
												return function (reblogged) {
													return function (reblogs_count) {
														return function (sensitive) {
															return function (spoiler_text) {
																return function (tags) {
																	return function (uri) {
																		return function (url) {
																			return function (visibility) {
																				return {account: account, application: application, content: content, created_at: created_at, favourited: favourited, favourites_count: favourites_count, id: id, in_reply_to_account_id: in_reply_to_account_id, in_reply_to_id: in_reply_to_id, media_attachments: media_attachments, mentions: mentions, reblog: reblog, reblogged: reblogged, reblogs_count: reblogs_count, sensitive: sensitive, spoiler_text: spoiler_text, tags: tags, uri: uri, url: url, visibility: visibility};
																			};
																		};
																	};
																};
...
function author$project$Mastodon$Decoder$cyclic$reblogDecoder() {
	return A2(
		elm$json$Json$Decode$map,
		author$project$Type$Reblog,
		elm$json$Json$Decode$lazy(
			function (_n1) {
				return author$project$Mastodon$Decoder$cyclic$statusDecoder();
			}));
}
function author$project$Mastodon$Decoder$cyclic$statusDecoder() {
	return A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'visibility',
		elm$json$Json$Decode$string,
		A3(
			...
			A3(
				...
				A3(
					NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
					'tags',
					elm$json$Json$Decode$list(author$project$Mastodon$Decoder$tagDecoder),
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'spoiler_text',
						elm$json$Json$Decode$string,
							...
							A3(
								...
								A4(
									...
									A4(
										...
										elm$json$Json$Decode$lazy(
											function (_n0) {
												return elm$json$Json$Decode$nullable(
													author$project$Mastodon$Decoder$cyclic$reblogDecoder());
											}),
										elm$core$Maybe$Nothing,
										A3(
											NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
											'mentions',
											elm$json$Json$Decode$list(author$project$Mastodon$Decoder$mentionDecoder),
											A3(
												NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
												'media_attachments',
												elm$json$Json$Decode$list(author$project$Mastodon$Decoder$attachmentDecoder),
												A3(
													NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
													'in_reply_to_id',
													elm$json$Json$Decode$nullable(author$project$Mastodon$Decoder$statusIdDecoder),
													A3(
														NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
														'in_reply_to_account_id',
														elm$json$Json$Decode$nullable(author$project$Mastodon$Decoder$idDecoder),
														A3(
															NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
															'id',
															author$project$Mastodon$Decoder$statusIdDecoder,
															A3(
																NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
																'favourites_count',
																elm$json$Json$Decode$int,
																	...
																	A3(
																		...
																		A3(
																			...
																			A3(
																				NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
																				'application',
																				elm$json$Json$Decode$nullable(author$project$Mastodon$Decoder$applicationDecoder),
																				A3(
																					NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
																					'account',
																					author$project$Mastodon$Decoder$accountDecoder,
																					elm$json$Json$Decode$succeed(author$project$Type$Status)))))))))))))))))))));
}
try {
	var author$project$Mastodon$Decoder$reblogDecoder = author$project$Mastodon$Decoder$cyclic$reblogDecoder();
	author$project$Mastodon$Decoder$cyclic$reblogDecoder = function () {
		return author$project$Mastodon$Decoder$reblogDecoder;
	};
	var author$project$Mastodon$Decoder$statusDecoder = author$project$Mastodon$Decoder$cyclic$statusDecoder();
	author$project$Mastodon$Decoder$cyclic$statusDecoder = function () {
		return author$project$Mastodon$Decoder$statusDecoder;
	};
} catch ($) {
throw 'Some top-level definitions from `Mastodon.Decoder` are causing infinite recursion:\n\n  ┌─────┐\n  │    reblogDecoder\n  │     ↓\n  │    statusDecoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.0/halting-problem to learn how to fix it!';}
var author$project$Page$Home$TimelineUpdated = function (a) {
	return {$: 'TimelineUpdated', a: a};
};
var author$project$Mastodon$Url$apiPrefix = '/api/v1';
var author$project$Mastodon$Url$accounts = author$project$Mastodon$Url$apiPrefix + '/accounts/';
var author$project$Mastodon$Url$account = function (id) {
	return _Utils_ap(author$project$Mastodon$Url$accounts, id);
};
var author$project$Mastodon$Url$accountTimeline = function (id) {
	return author$project$Mastodon$Url$account(id) + '/statuses';
};
var elm$url$Url$Https = {$: 'Https'};
var author$project$Request$Timeline$url = F2(
	function (instance, path) {
		return {fragment: elm$core$Maybe$Nothing, host: instance, path: path, port_: elm$core$Maybe$Nothing, protocol: elm$url$Url$Https, query: elm$core$Maybe$Nothing};
	});
...
var truqu$elm_oauth2$OAuth$tokenToString = function (_n0) {
	var t = _n0.a;
	return 'Bearer ' + t;
};
...
var author$project$Request$Timeline$accountTimeline = F4(
	function (instance, token, _n0, decoder) {
		var id = _n0.id;
			...
			elm$http$Http$request(
				{
					...
					url: elm$url$Url$toString(
						A2(
							author$project$Request$Timeline$url,
							instance,
							author$project$Mastodon$Url$accountTimeline(id))),
					withCredentials: false
				}));
	});
var author$project$Mastodon$Url$favouriteTimeline = author$project$Mastodon$Url$apiPrefix + '/favourites';
var author$project$Request$Timeline$favouriteTimeline = F3(
	function (instance, token, decoder) {
		return krisajenkins$remotedata$RemoteData$sendRequest(
			elm$http$Http$request(
				{
					body: elm$http$Http$emptyBody,
					...
					timeout: elm$core$Maybe$Nothing,
					url: elm$url$Url$toString(
						A2(author$project$Request$Timeline$url, instance, author$project$Mastodon$Url$favouriteTimeline)),
					withCredentials: false
				}));
	});
var author$project$Mastodon$Url$homeTimeline = author$project$Mastodon$Url$apiPrefix + '/timelines/home';
var author$project$Request$Timeline$homeTimeline = F3(
	function (instance, token, decoder) {
		return krisajenkins$remotedata$RemoteData$sendRequest(
			elm$http$Http$request(
				{
					...
					timeout: elm$core$Maybe$Nothing,
					url: elm$url$Url$toString(
						A2(author$project$Request$Timeline$url, instance, author$project$Mastodon$Url$homeTimeline)),
					withCredentials: false
				}));
	});
var author$project$Mastodon$Url$publicTimeline = author$project$Mastodon$Url$apiPrefix + '/timelines/public';
var author$project$Request$Timeline$publicTimeline = F3(
	function (instance, token, decoder) {
		return krisajenkins$remotedata$RemoteData$sendRequest(
			elm$http$Http$request(
				{
					...
					timeout: elm$core$Maybe$Nothing,
					url: elm$url$Url$toString(
						A2(author$project$Request$Timeline$url, instance, author$project$Mastodon$Url$publicTimeline)),
					withCredentials: false
				}));
	});
var author$project$Page$Home$initCmd = F2(
	function (mode, _n0) {
		var instance = _n0.instance;
		var token = _n0.token;
		var account = _n0.account;
		var decode = elm$json$Json$Decode$list(author$project$Mastodon$Decoder$statusDecoder);
		return A2(
			elm$core$Platform$Cmd$map,
			author$project$Page$Home$TimelineUpdated,
			function () {
				switch (mode.$) {
					case 'HomeTimeline':
						return A4(author$project$Request$Timeline$accountTimeline, instance, token, account, decode);
					case 'LocalTimeline':
						return A3(author$project$Request$Timeline$publicTimeline, instance, token, decode);
					case 'FederatedTimeline':
						return A3(author$project$Request$Timeline$homeTimeline, instance, token, decode);
					default:
						return A3(author$project$Request$Timeline$favouriteTimeline, instance, token, decode);
				}
			}());
	});
var krisajenkins$remotedata$RemoteData$NotAsked = {$: 'NotAsked'};
var author$project$Page$Home$init = F3(
	function (key, timelineMode, client) {
		var instance = client.instance;
		var token = client.token;
		return _Utils_Tuple2(
			A5(author$project$Page$Home$Model, 'Welcome on the Fediverse...', key, timelineMode, client, krisajenkins$remotedata$RemoteData$NotAsked),
			A2(author$project$Page$Home$initCmd, timelineMode, client));
	});
var author$project$Main$goHome = F4(
	function (model, token, account, msg) {
		return A2(
			...
			A3(
				...
				model.key,
				msg,
				{account: account, instance: model.auth.instance, token: token}));
	});
...
var author$project$Main$stepCreate = F2(
	function (model, _n0) {
		var create = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$Create(create)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$CreateMsg, cmds));
	});
var author$project$Main$Inbox = function (a) {
	return {$: 'Inbox', a: a};
};
var author$project$Main$InboxMsg = function (a) {
	return {$: 'InboxMsg', a: a};
};
var author$project$Main$stepInbox = F2(
	function (model, _n0) {
		var inbox = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$Inbox(inbox)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$InboxMsg, cmds));
	});
var author$project$Main$Lock = function (a) {
	return {$: 'Lock', a: a};
};
var author$project$Main$LockMsg = function (a) {
	return {$: 'LockMsg', a: a};
};
var author$project$Main$stepLock = F2(
	function (model, _n0) {
		var lock = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$Lock(lock)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$LockMsg, cmds));
	});
var author$project$Main$Notification = function (a) {
	return {$: 'Notification', a: a};
};
var author$project$Main$NotificationMsg = function (a) {
	return {$: 'NotificationMsg', a: a};
};
var author$project$Main$stepNotification = F2(
	function (model, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$Notification(notification)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$NotificationMsg, cmds));
	});
...
var author$project$Page$Create$Model = F3(
	function (title, key, client) {
		return {client: client, key: key, title: title};
	});
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Page$Create$init = F2(
	function (key, client) {
		var instance = client.instance;
		var token = client.token;
		return _Utils_Tuple2(
			A3(author$project$Page$Create$Model, 'Notifications', key, client),
			elm$core$Platform$Cmd$none);
	});
var author$project$Page$Home$FavoritesTimeline = {$: 'FavoritesTimeline'};
var author$project$Page$Home$FederatedTimeline = {$: 'FederatedTimeline'};
var author$project$Page$Home$HomeTimeline = {$: 'HomeTimeline'};
var author$project$Page$Home$LocalTimeline = {$: 'LocalTimeline'};
var author$project$Page$Inbox$Model = F3(
	function (title, key, client) {
		return {client: client, key: key, title: title};
	});
var author$project$Page$Inbox$init = F2(
	function (key, client) {
		var instance = client.instance;
		var token = client.token;
		return _Utils_Tuple2(
			A3(author$project$Page$Inbox$Model, 'Notifications', key, client),
			elm$core$Platform$Cmd$none);
	});
var author$project$Page$Lock$Model = F3(
	function (title, key, client) {
		return {client: client, key: key, title: title};
	});
var author$project$Page$Lock$init = F2(
	function (key, client) {
		var instance = client.instance;
		var token = client.token;
		return _Utils_Tuple2(
			A3(author$project$Page$Lock$Model, 'Notifications', key, client),
			elm$core$Platform$Cmd$none);
	});
var author$project$Page$Notification$Model = F3(
	function (title, key, client) {
		return {client: client, key: key, title: title};
	});
var author$project$Page$Notification$init = F2(
	function (key, client) {
		var instance = client.instance;
		var token = client.token;
		return _Utils_Tuple2(
			A3(author$project$Page$Notification$Model, 'Notifications', key, client),
			elm$core$Platform$Cmd$none);
	});
...
var author$project$Page$Search$init = F2(
	function (key, client) {
		var instance = client.instance;
		var token = client.token;
		return _Utils_Tuple2(
			A3(author$project$Page$Search$Model, 'Notifications', key, client),
			elm$core$Platform$Cmd$none);
	});
...
var author$project$Main$protectedUrl = F4(
	function (url, model, token, account) {
		var parser = elm$url$Url$Parser$oneOf(
			_List_fromArray(
				[
					...
					A4(author$project$Main$goHome, model, token, account, author$project$Page$Home$HomeTimeline)),
					A2(
					author$project$Main$route,
					elm$url$Url$Parser$s('local'),
					A4(author$project$Main$goHome, model, token, account, author$project$Page$Home$LocalTimeline)),
					A2(
					author$project$Main$route,
					elm$url$Url$Parser$s('federated'),
					A4(author$project$Main$goHome, model, token, account, author$project$Page$Home$FederatedTimeline)),
					A2(
					author$project$Main$route,
					elm$url$Url$Parser$s('favorites'),
					A4(author$project$Main$goHome, model, token, account, author$project$Page$Home$FavoritesTimeline)),
					A2(
					author$project$Main$route,
					elm$url$Url$Parser$s('create'),
					A2(
						author$project$Main$stepCreate,
						model,
						A2(
							author$project$Page$Create$init,
							model.key,
							{account: account, instance: model.auth.instance, token: token}))),
					A2(
					author$project$Main$route,
					elm$url$Url$Parser$s('inbox'),
					A2(
						author$project$Main$stepInbox,
						model,
						A2(
							author$project$Page$Inbox$init,
							model.key,
							{account: account, instance: model.auth.instance, token: token}))),
					A2(
					author$project$Main$route,
					elm$url$Url$Parser$s('lock'),
					A2(
						author$project$Main$stepLock,
						model,
						A2(
							author$project$Page$Lock$init,
							model.key,
							{account: account, instance: model.auth.instance, token: token}))),
					A2(
					author$project$Main$route,
					...
					A2(
						author$project$Main$stepNotification,
						model,
						A2(
							author$project$Page$Notification$init,
							model.key,
							{account: account, instance: model.auth.instance, token: token}))),
					A2(
					author$project$Main$route,
	...
	return A2(
		...
		A2(
			...
			A2(
				elm$core$Maybe$map,
				function (_n0) {
					var clientId = _n0.clientId;
					var secret = _n0.secret;
...
var truqu$elm_oauth2$OAuth$makeRefreshToken = F2(
	function (tokenType, mToken) {
		var construct = F2(
			function (a, b) {
				return truqu$elm_oauth2$OAuth$tokenFromString(a + (' ' + b));
			});
		var _n0 = _Utils_Tuple2(
			mToken,
			A3(
...
var truqu$elm_oauth2$OAuth$makeToken = F2(
	function (mTokenType, mToken) {
		var construct = F2(
			function (a, b) {
				return truqu$elm_oauth2$OAuth$tokenFromString(a + (' ' + b));
			});
		return A3(truqu$elm_oauth2$OAuth$maybeAndThen2, construct, mTokenType, mToken);
	});
...
var truqu$elm_oauth2$Internal$makeRequest = F3(
	function (url, headers, body) {
		return {
			body: A2(elm$http$Http$stringBody, 'application/x-www-form-urlencoded', body),
			expect: elm$http$Http$expectJson(truqu$elm_oauth2$Internal$authenticationSuccessDecoder),
			headers: headers,
			method: 'POST',
			timeout: elm$core$Maybe$Nothing,
...
var truqu$elm_oauth2$OAuth$AuthorizationCode$makeTokenRequest = function (_n0) {
	var credentials = _n0.credentials;
	var code = _n0.code;
	var url = _n0.url;
	var redirectUri = _n0.redirectUri;
	var headers = truqu$elm_oauth2$Internal$makeHeaders(
		function () {
			var _n1 = credentials.secret;
			if (_n1.$ === 'Nothing') {
				return elm$core$Maybe$Nothing;
			} else {
				var secret = _n1.a;
	...
	return A3(truqu$elm_oauth2$Internal$makeRequest, url, headers, body);
};
var author$project$Main$getAccessToken = F4(
	function (auth, config, redirectUri, code) {
...
var author$project$Main$updateAuthError = F2(
...
var author$project$Mastodon$Url$oauthAuthorize = '/oauth/authorize';
var author$project$Mastodon$Url$oauthToken = '/oauth/token';
var author$project$Mastodon$Url$userAccount = author$project$Mastodon$Url$accounts + 'verify_credentials';
var author$project$Page$SignIn$configuration = function () {
	...
	return {
		accountDecoder: author$project$Mastodon$Decoder$accountDecoder,
		accountEndpoint: _Utils_update(
			defaultHttpsUrl,
			{path: author$project$Mastodon$Url$userAccount}),
		authorizationEndpoint: _Utils_update(
			defaultHttpsUrl,
			{path: author$project$Mastodon$Url$oauthAuthorize}),
		...
		tokenEndpoint: _Utils_update(
			defaultHttpsUrl,
			{path: author$project$Mastodon$Url$oauthToken})
	};
}();
...
var author$project$Page$SignIn$Error$toString = function (_n0) {
	var error = _n0.error;
	var errorDescription = _n0.errorDescription;
	var desc = A3(
		elm$core$String$replace,
		'+',
		' ',
		A2(elm$core$Maybe$withDefault, '', errorDescription));
	var code = truqu$elm_oauth2$OAuth$errorCodeToString(error);
	return code + (': ' + desc);
};
...
var truqu$elm_oauth2$OAuth$AuthorizationCode$parseCodeWith = F2(
	function (_n0, url_) {
		var codeParser = _n0.codeParser;
		var errorParser = _n0.errorParser;
		var authorizationSuccessParser = _n0.authorizationSuccessParser;
		var authorizationErrorParser = _n0.authorizationErrorParser;
...
var author$project$Main$stepSignIn = F2(
	function (model, url) {
		var auth = model.auth;
		var _n0 = truqu$elm_oauth2$OAuth$AuthorizationCode$parseCode(url);
		switch (_n0.$) {
			case 'Empty':
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			case 'Success':
				var code = _n0.a.code;
				var state = _n0.a.state;
				return (!_Utils_eq(
					state,
					elm$core$Maybe$Just(auth.state))) ? _Utils_Tuple2(
					A2(
						author$project$Main$updateAuthError,
						model,
						elm$core$Maybe$Just('\'state\' doesn\'t match, the request has likely been forged by an adversary!')),
					elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{page: author$project$Main$Fetching}),
					A4(author$project$Main$getAccessToken, auth, author$project$Page$SignIn$configuration, auth.redirectUri, code));
			default:
				var error = _n0.a.error;
				var errorDescription = _n0.a.errorDescription;
				return _Utils_Tuple2(
					A2(
						author$project$Main$updateAuthError,
						model,
						elm$core$Maybe$Just(
							author$project$Page$SignIn$Error$toString(
...
var author$project$Main$stepUrl = F2(
	function (url, model) {
		var auth = model.auth;
		var _n0 = _Utils_Tuple2(auth.token, auth.account);
		if ((_n0.a.$ === 'Just') && (_n0.b.$ === 'Just')) {
			var token = _n0.a.a;
			var account = _n0.b.a;
			return A4(author$project$Main$protectedUrl, url, model, token, account);
		} else {
			return A2(author$project$Main$stepSignIn, model, url);
		}
	});
...
var author$project$Theme$createColorPalette = {
	accent: rtfeldman$elm_css$Css$hex('0083BB'),
	appBackground: A4(rtfeldman$elm_css$Css$rgba, 255, 255, 255, 0.9),
	dark: rtfeldman$elm_css$Css$hex('7E8D85'),
	darkText: rtfeldman$elm_css$Css$hex('000000'),
	lightBackground: rtfeldman$elm_css$Css$hex('FFFFFF'),
	lightText: rtfeldman$elm_css$Css$hex('FFFFFF'),
	major: rtfeldman$elm_css$Css$hex('29BF89'),
	mediumBackground: rtfeldman$elm_css$Css$hex('E3E3E3'),
	warning: rtfeldman$elm_css$Css$hex('B60606')
};
...
var author$project$Theme$createTheme = function () {
	var layout = {
		compactMargin: rtfeldman$elm_css$Css$rem(0.75),
		defaultMargin: rtfeldman$elm_css$Css$rem(1.25),
		navigationHeight: rtfeldman$elm_css$Css$rem(3.25),
		secondSidebarWidth: rtfeldman$elm_css$Css$rem(9),
		sidebarWidth: rtfeldman$elm_css$Css$rem(15),
		smallMargin: rtfeldman$elm_css$Css$rem(0.5)
	};
	var styles = {
		blockMargin: A2(rtfeldman$elm_css$Css$margin2, layout.smallMargin, layout.compactMargin),
		contentFontFamily: rtfeldman$elm_css$Css$fontFamilies(
			_List_fromArray(
				['Work Sans', 'serif'])),
		contentPadding: A2(rtfeldman$elm_css$Css$padding2, layout.smallMargin, layout.compactMargin),
		contentSidePadding: A2(
			rtfeldman$elm_css$Css$padding2,
			rtfeldman$elm_css$Css$px(0),
			layout.compactMargin),
		headlineFontFamily: rtfeldman$elm_css$Css$fontFamilies(
			_List_fromArray(
				['Work Sans', 'serif'])),
		headlineFontWeight: rtfeldman$elm_css$Css$fontWeight(
			rtfeldman$elm_css$Css$int(900)),
		navigationHeight: rtfeldman$elm_css$Css$height(layout.navigationHeight)
	};
	return {colors: author$project$Theme$createColorPalette, layout: layout, styles: styles};
}();
var author$project$Type$initAuth = F2(
	function (bytes, url) {
		return {
			account: elm$core$Maybe$Nothing,
...
var author$project$Type$resumeAuth = F3(
	function (_n0, bytes, url) {
		var instance = _n0.instance;
		var token = _n0.token;
		var account = _n0.account;
		var a = A2(author$project$Type$initAuth, bytes, url);
		return _Utils_update(
			a,
			{
				account: elm$core$Maybe$Just(account),
				instance: instance,
...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		var randomBytes = _n0.randomBytes;
		var clients = _n0.clients;
		var client = author$project$Main$resumeClient(clients);
		var auth = function () {
			var _n1 = author$project$Main$resumeClient(clients);
			if (_n1.$ === 'Ok') {
				var maybeClient = _n1.a;
				if (maybeClient.$ === 'Just') {
					var c = maybeClient.a;
					return A3(author$project$Type$resumeAuth, c, randomBytes, url);
				} else {
					return A2(author$project$Type$initAuth, randomBytes, url);
				}
			} else {
				return A2(author$project$Type$initAuth, randomBytes, url);
			}
		...
		return A2(
			...
			url,
			{auth: auth, key: key, page: author$project$Main$SignIn, theme: author$project$Theme$createTheme});
	});
...
var author$project$Main$getUserInfo = F3(
	function (auth, _n0, token) {
		var accountEndpoint = _n0.accountEndpoint;
		var accountDecoder = _n0.accountDecoder;
		return A2(
			elm$http$Http$send,
			...
			elm$http$Http$request(
				{
					body: elm$http$Http$emptyBody,
					expect: elm$http$Http$expectJson(accountDecoder),
					headers: A2(truqu$elm_oauth2$OAuth$useToken, token, _List_Nil),
					method: 'GET',
					timeout: elm$core$Maybe$Nothing,
					url: elm$url$Url$toString(
...
var author$project$Account$encoder = function (account) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'acct',
				elm$json$Json$Encode$string(account.acct)),
				_Utils_Tuple2(
				'avatar',
				elm$json$Json$Encode$string(account.avatar)),
				_Utils_Tuple2(
				'created_at',
				elm$json$Json$Encode$string(
					rtfeldman$elm_iso8601_date_strings$Iso8601$fromTime(account.created_at))),
				_Utils_Tuple2(
				'display_name',
				elm$json$Json$Encode$string(account.display_name)),
				_Utils_Tuple2(
				'followers_count',
				elm$json$Json$Encode$int(account.followers_count)),
				_Utils_Tuple2(
				'following_count',
				elm$json$Json$Encode$int(account.following_count)),
				_Utils_Tuple2(
				'header',
				elm$json$Json$Encode$string(account.header)),
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$string(account.id)),
				_Utils_Tuple2(
				'locked',
				elm$json$Json$Encode$bool(account.locked)),
				_Utils_Tuple2(
				'note',
				elm$json$Json$Encode$string(account.note)),
				_Utils_Tuple2(
				'statuses_count',
				elm$json$Json$Encode$int(account.statuses_count)),
				_Utils_Tuple2(
				'url',
				elm$json$Json$Encode$string(account.url)),
				_Utils_Tuple2(
				'username',
				elm$json$Json$Encode$string(account.username))
			]));
};
var author$project$Main$clientEncoder = function (client) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'instance',
				elm$json$Json$Encode$string(client.instance)),
				_Utils_Tuple2(
				'token',
				elm$json$Json$Encode$string(
					truqu$elm_oauth2$OAuth$tokenToString(client.token))),
				_Utils_Tuple2(
				'account',
				author$project$Account$encoder(client.account))
			]));
};
var author$project$Main$toJson = elm$json$Json$Encode$encode(0);
var author$project$Ports$saveClients = _Platform_outgoingPort('saveClients', elm$json$Json$Encode$string);
...
var author$project$Main$saveClients = function (clients) {
	return author$project$Ports$saveClients(
		truqu$elm_base64$Base64$encode(
			author$project$Main$toJson(
				A2(
					elm$json$Json$Encode$list,
					elm$core$Basics$identity,
					A2(elm$core$List$map, author$project$Main$clientEncoder, clients)))));
};
var author$project$Main$updateAuthAccount = F2(
	function (model, value) {
		var c = model.auth;
		var u = _Utils_update(
			c,
...
var author$project$Main$updateAuthInstance = F2(
	function (model, value) {
		var c = model.auth;
		var u = _Utils_update(
			c,
...
var author$project$Main$updateAuthToken = F2(
	function (model, value) {
		var c = model.auth;
		var u = _Utils_update(
			c,
...
var author$project$Page$Create$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Navigate':
				...
				return _Utils_Tuple2(
					model,
					A2(elm$browser$Browser$Navigation$pushUrl, model.key, href));
			default:
				var timeline = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$Page$Inbox$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
	});
var author$project$Page$Lock$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
	});
...
var truqu$elm_oauth2$Internal$Code = {$: 'Code'};
...
var truqu$elm_oauth2$OAuth$AuthorizationCode$makeAuthUrl = truqu$elm_oauth2$Internal$makeAuthUrl(truqu$elm_oauth2$Internal$Code);
	...
	function (message, model) {
		...
		switch (message.$) {
			...
			case 'CreateMsg':
				...
				if (_n2.$ === 'Create') {
					...
					return A2(
						author$project$Main$stepCreate,
						model,
						A2(author$project$Page$Create$update, msg, create));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'HomeMsg':
			...
			case 'InboxMsg':
				...
				if (_n4.$ === 'Inbox') {
					...
					return A2(
						author$project$Main$stepInbox,
						model,
						A2(author$project$Page$Inbox$update, msg, inbox));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'LockMsg':
				...
				if (_n5.$ === 'Lock') {
					...
					return A2(
						author$project$Main$stepLock,
						model,
						A2(author$project$Page$Lock$update, msg, lock));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'NotificationMsg':
				...
				var _n6 = model.page;
				if (_n6.$ === 'Notification') {
					var notification = _n6.a;
					return A2(
						author$project$Main$stepNotification,
						model,
						A2(author$project$Page$Notification$update, msg, notification));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'SearchMsg':
			...
			case 'SignInRequested':
				var clientId = message.a.clientId;
				var authorizationEndpoint = message.a.authorizationEndpoint;
				var scope = message.a.scope;
				return _Utils_Tuple2(
					model,
							...
							truqu$elm_oauth2$OAuth$AuthorizationCode$makeAuthUrl(
								{
									...
									scope: scope,
									state: elm$core$Maybe$Just(model.auth.state),
									url: _Utils_update(
			...
			case 'SetInstance':
				var value = message.a;
				return _Utils_Tuple2(
					A2(author$project$Main$updateAuthInstance, model, value),
					elm$core$Platform$Cmd$none);
			case 'SignOutRequested':
				return _Utils_Tuple2(
					model,
					elm$browser$Browser$Navigation$load(
						elm$url$Url$toString(auth.redirectUri)));
			case 'GotAccessToken':
				var config = message.a;
				var res = message.b;
				if (res.$ === 'Err') {
					if (res.a.$ === 'BadStatus') {
						var body = res.a.a.body;
						var _n9 = A2(elm$json$Json$Decode$decodeString, truqu$elm_oauth2$OAuth$AuthorizationCode$defaultAuthenticationErrorDecoder, body);
						if (_n9.$ === 'Ok') {
							var error = _n9.a.error;
							var errorDescription = _n9.a.errorDescription;
							var errMsg = 'Unable to retrieve token: ' + author$project$Page$SignIn$Error$toString(
								{error: error, errorDescription: errorDescription});
							return _Utils_Tuple2(
								A2(
									author$project$Main$updateAuthError,
									model,
									elm$core$Maybe$Just(errMsg)),
								elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(
								A2(
									author$project$Main$updateAuthError,
									model,
									elm$core$Maybe$Just('Unable to retrieve token: ' + body)),
								elm$core$Platform$Cmd$none);
						}
					} else {
						return _Utils_Tuple2(
							A2(
								author$project$Main$updateAuthError,
								model,
								elm$core$Maybe$Just('CORS is likely disabled on the authorization server. Unable to retrieve token: HTTP request failed.')),
							elm$core$Platform$Cmd$none);
					}
				} else {
					var token = res.a.token;
					return _Utils_Tuple2(
						A2(
							author$project$Main$updateAuthToken,
							model,
							elm$core$Maybe$Just(token)),
						A3(author$project$Main$getUserInfo, auth, config, token));
				}
			default:
				var res = message.a;
				if (res.$ === 'Err') {
					...
					return _Utils_Tuple2(
						A2(
							author$project$Main$updateAuthError,
							model,
							elm$core$Maybe$Just('Unable to fetch user account ¯\\_(ツ)_/¯')),
						elm$core$Platform$Cmd$none);
				} else {
					var account = res.a;
					return _Utils_Tuple2(
						A2(
							author$project$Main$updateAuthAccount,
							model,
							elm$core$Maybe$Just(account)),
						elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									if (_n11.$ === 'Just') {
										var token = _n11.a;
										return author$project$Main$saveClients(
											_List_fromArray(
												[
													A3(author$project$Type$Client, auth.instance, token, account)
												]));
									} else {
...
var author$project$Document$toUnstyledDocument = function (doc) {
	return {
		body: A2(elm$core$List$map, rtfeldman$elm_css$Html$Styled$toUnstyled, doc.body),
		title: doc.title
	};
};
var author$project$Main$SetInstance = function (a) {
	return {$: 'SetInstance', a: a};
};
var author$project$Main$SignInRequested = function (a) {
	return {$: 'SignInRequested', a: a};
};
...
var author$project$Page$SignIn$viewError = F2(
					...
					[
						...
						_List_fromArray(
							[
								...
								rtfeldman$elm_css$Css$backgroundColor(theme.colors.warning),
								rtfeldman$elm_css$Css$color(theme.colors.lightText),
...
var author$project$Page$SignIn$viewBody = F3(
	function (theme, auth, content) {
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			A2(
				elm$core$List$cons,
				A2(author$project$Page$SignIn$viewError, theme, auth.error),
				content));
	});
...
var author$project$Page$SignIn$viewLogin = function (_n0) {
...
var author$project$Page$SignIn$view = F3(
	function (theme, _n0, auth) {
		var onSignOut = _n0.onSignOut;
		var buttons = _n0.buttons;
		return A3(
			author$project$Page$SignIn$viewBody,
			theme,
			auth,
			author$project$Page$SignIn$viewLogin(
				{buttons: buttons}));
	});
...
var author$project$Page$SignIn$viewInput = F4(
...
var author$project$Page$SignIn$viewSignInButton = F3(
	function (auth, setInstanceMsg, onSignIn) {
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A4(author$project$Page$SignIn$viewInput, 'text', 'Instance', auth.instance, setInstanceMsg),
							A2(
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('You\'ll be redirected to that server to authenticate yourself. We don\'t have access to your password. We respect your privacy, we don\'t store anything.')
						]))
				]));
	});
...
var author$project$Main$signInView = F2(
	function (theme, auth) {
		return A3(
			author$project$Page$SignIn$view,
			theme,
			{
				buttons: _List_fromArray(
					[
						A3(
						author$project$Page$SignIn$viewSignInButton,
						auth,
						author$project$Main$SetInstance,
						rtfeldman$elm_css$Html$Styled$Events$onClick(
							author$project$Main$SignInRequested(author$project$Page$SignIn$configuration)))
					]),
...
var author$project$Image$squaredImage = F3(
	function (dimension, radius, maybeImage) {
		var style = _List_fromArray(
			[
				rtfeldman$elm_css$Css$width(dimension),
				rtfeldman$elm_css$Css$height(dimension),
				rtfeldman$elm_css$Css$borderRadius(radius),
				A2(rtfeldman$elm_css$Css$property, 'object-fit', 'cover')
			]);
		if (maybeImage.$ === 'Just') {
			var imageUrl = maybeImage.a;
			return A2(
...
var author$project$Image$accountImage = function (maybeImage) {
	return A3(
		author$project$Image$squaredImage,
		rtfeldman$elm_css$Css$rem(6),
		rtfeldman$elm_css$Css$rem(0.5),
		maybeImage);
};
var rtfeldman$elm_css$Css$batch = rtfeldman$elm_css$Css$Preprocess$ApplyStyles;
var author$project$Theme$headline = function (theme) {
	return rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[theme.styles.headlineFontFamily, theme.styles.headlineFontWeight]));
};
...
var author$project$View$Account$view = F2(
	function (theme, account) {
		return _List_fromArray(
			[
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				...
				_List_fromArray(
					[
						author$project$Image$accountImage(
						elm$core$Maybe$Just(account.avatar))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										author$project$Theme$headline(theme),
										rtfeldman$elm_css$Css$fontSize(
										rtfeldman$elm_css$Css$rem(1.34))
									]))
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(account.display_name)
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										rtfeldman$elm_css$Css$int(500)),
										rtfeldman$elm_css$Css$fontSize(
										rtfeldman$elm_css$Css$rem(0.95)),
										rtfeldman$elm_css$Css$fontStyle(rtfeldman$elm_css$Css$italic)
									]))
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('@' + account.username)
							]))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(account.note)
					]))
			]);
	});
var rtfeldman$elm_css$Html$Styled$i = rtfeldman$elm_css$Html$Styled$node('i');
var rtfeldman$elm_css$Html$Styled$Attributes$class = rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('className');
var author$project$Icon$icon = function (name) {
	return A2(
		rtfeldman$elm_css$Html$Styled$i,
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$class('ion-' + name)
			]),
		_List_Nil);
};
var author$project$Image$circularAccountImage = function (maybeImage) {
	return A3(
		author$project$Image$squaredImage,
...
var author$project$View$WhoToFollow$accountSuggestion = F2(
	function (theme, maybeImage) {
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									rtfeldman$elm_css$Css$backgroundColor(theme.colors.lightBackground),
									rtfeldman$elm_css$Css$borderRadius(
									...
									_List_fromArray(
										[
											rtfeldman$elm_css$Css$Transitions$backgroundColor(180),
											rtfeldman$elm_css$Css$Transitions$opacity(220)
										])),
									rtfeldman$elm_css$Css$hover(
									_List_fromArray(
										[
											rtfeldman$elm_css$Css$backgroundColor(theme.colors.major),
											rtfeldman$elm_css$Css$opacity(
					...
					_List_fromArray(
						[
							author$project$Image$circularAccountImage(maybeImage),
							A2(
							rtfeldman$elm_css$Html$Styled$span,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									author$project$Icon$icon('person-add')
								])),
							A2(
							rtfeldman$elm_css$Html$Styled$span,
							_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Dominique Feyer')
								])),
							A2(
							rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('@dfeyer@social.ttree.ch')
								]))
						]))
				]));
	});
var author$project$View$WhoToFollow$accountSuggestionList = function (theme) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				author$project$View$WhoToFollow$accountSuggestion,
				theme,
				elm$core$Maybe$Just('https://picsum.photos/200/300?random')),
				A2(
				author$project$View$WhoToFollow$accountSuggestion,
				theme,
				elm$core$Maybe$Just('https://picsum.photos/200/300?random')),
...
var author$project$View$WhoToFollow$asideLink = F3(
	function (_n0, iconName, label) {
		var colors = _n0.colors;
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$fontWeight(
							rtfeldman$elm_css$Css$int(500)),
							rtfeldman$elm_css$Css$color(colors.accent),
							rtfeldman$elm_css$Css$textDecoration(rtfeldman$elm_css$Css$none)
						]))
				]),
			_List_fromArray(
				[
					author$project$Icon$icon(iconName),
					A2(
					rtfeldman$elm_css$Html$Styled$span,
					_List_fromArray(
						[
...
var author$project$View$WhoToFollow$view = F2(
	function (theme, account) {
		return _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('Who to follow')
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										theme.layout.defaultMargin,
										rtfeldman$elm_css$Css$rem(0))
									]))
							]),
						_List_fromArray(
							[
								A3(author$project$View$WhoToFollow$asideLink, theme, 'refresh', 'Refresh'),
								A3(author$project$View$WhoToFollow$asideLink, theme, 'eye', 'View all')
							])),
						author$project$View$WhoToFollow$accountSuggestionList(theme)
					]))
			]);
	});
...
var author$project$View$Zone$aside = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$int(0),
							layout.secondSidebarWidth),
							rtfeldman$elm_css$Css$paddingLeft(layout.smallMargin),
							rtfeldman$elm_css$Css$marginRight(
							rtfeldman$elm_css$Css$rem(1))
						]))
				]),
...
var author$project$View$Zone$mainArea = F2(
	function (_n0, content) {
...
var author$project$View$Zone$sidebar = F2(
	function (_n0, content) {
		var layout = _n0.layout;
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$int(0),
							layout.sidebarWidth),
							rtfeldman$elm_css$Css$paddingLeft(layout.defaultMargin)
						]))
				]),
			content);
	});
var author$project$Page$Create$viewContent = F2(
	function (theme, _n0) {
		var client = _n0.client;
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2(
					author$project$View$Zone$sidebar,
					theme,
					A2(author$project$View$Account$view, theme, client.account)),
					A2(
					author$project$View$Zone$mainArea,
					theme,
					_List_fromArray(
						[
							A2(
					...
					A2(
					author$project$View$Zone$aside,
					theme,
					A2(author$project$View$WhoToFollow$view, theme, client.account))
				]));
	});
...
var author$project$Page$Create$view = F2(
	function (model, theme) {
		return {
			...
			kids: _List_fromArray(
				[
					A2(author$project$Page$Create$viewContent, theme, model)
				]),
			sidebar: _List_Nil,
			theme: theme,
...
var author$project$Image$smallAccountImage = function (maybeImage) {
	return A3(
		author$project$Image$squaredImage,
...
var author$project$View$Status$statusAccount = F2(
	function (theme, _n0) {
		var display_name = _n0.display_name;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text(display_name)
						])),
					A2(
					rtfeldman$elm_css$Html$Styled$span,
					_List_fromArray(
...
var author$project$View$Status$statusActionGroupLink = F3(
	function (theme, label, iconName) {
		return A2(
			rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Css$display(rtfeldman$elm_css$Css$block),
							rtfeldman$elm_css$Css$color(theme.colors.darkText),
							rtfeldman$elm_css$Css$marginLeft(
							rtfeldman$elm_css$Css$rem(1.5)),
							rtfeldman$elm_css$Css$opacity(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Css$Transitions$opacity(180),
									A3(rtfeldman$elm_css$Css$Transitions$transform3, 240, 0, rtfeldman$elm_css$Css$Transitions$easeInOut)
								])),
							rtfeldman$elm_css$Css$hover(
							_List_fromArray(
								[
...
var author$project$View$Status$statusActionGroup = function (theme) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Css$rem(0.35)),
						rtfeldman$elm_css$Css$justifyContent(rtfeldman$elm_css$Css$end)
					]))
			]),
		_List_fromArray(
			[
				A3(author$project$View$Status$statusActionGroupLink, theme, 'Send a resonse...', 'arrow-return-left'),
				A3(author$project$View$Status$statusActionGroupLink, theme, 'Boost', 'loop'),
				A3(author$project$View$Status$statusActionGroupLink, theme, 'Add to your favorits', 'android-star')
			]));
};
...
var author$project$View$Formatter$getHashtagForLink = function (attrs) {
	var href = A2(
		elm$core$Maybe$withDefault,
		'',
		A2(
	...
	var mastodonHashtag = A2(elm_community$string_extra$String$Extra$rightOf, '/tags/', href);
	var hashtag = (mastodonHashtag !== '') ? mastodonHashtag : A2(elm_community$string_extra$String$Extra$rightOf, '/tag/', href);
	return (hashtag !== '') ? elm$core$Maybe$Just(hashtag) : elm$core$Maybe$Nothing;
};
var author$project$View$Formatter$getHrefLink = function (attrs) {
...
var author$project$View$Formatter$getMentionForLink = F2(
	function (attrs, mentions) {
		var _n0 = author$project$View$Formatter$getHrefLink(attrs);
		if (_n0.$ === 'Just') {
			var href = _n0.a;
			return elm$core$List$head(
				A2(
...
var author$project$View$Formatter$toAttribute = function (_n0) {
	var name = _n0.a;
	var value = _n0.b;
	return A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, name, value);
};
var rtfeldman$elm_css$Html$Styled$Attributes$target = rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('target');
var author$project$View$Formatter$createLinkNode = F3(
	function (attrs, children, mentions) {
		var _n1 = A2(author$project$View$Formatter$getMentionForLink, attrs, mentions);
		if (_n1.$ === 'Just') {
			var mention = _n1.a;
			return A3(
				...
				'a',
				_Utils_ap(
					A2(elm$core$List$map, author$project$View$Formatter$toAttribute, attrs),
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$href('/account/' + mention.id)
						])),
				A2(author$project$View$Formatter$toVirtualDom, mentions, children));
		} else {
			var _n2 = author$project$View$Formatter$getHashtagForLink(attrs);
			if (_n2.$ === 'Just') {
				var hashtag = _n2.a;
				return A3(
					rtfeldman$elm_css$Html$Styled$node,
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$href('/tags/' + hashtag)
							])),
					A2(author$project$View$Formatter$toVirtualDom, mentions, children));
			} else {
				return A3(
...
var author$project$View$Formatter$toVirtualDom = F2(
	function (mentions, nodes) {
		return A2(
			elm$core$List$map,
			author$project$View$Formatter$toVirtualDomEach(mentions),
			nodes);
	});
var author$project$View$Formatter$toVirtualDomEach = F2(
		...
		switch (node.$) {
			case 'Element':
				if (node.a === 'a') {
					var attrs = node.b;
					var children = node.c;
					return A3(author$project$View$Formatter$createLinkNode, attrs, children, mentions);
				} else {
					var name = node.a;
					var attrs = node.b;
					var children = node.c;
			...
			case 'Text':
				var text_ = node.a;
				return rtfeldman$elm_css$Html$Styled$text(text_);
			default:
...
var author$project$View$Formatter$formatContent = F2(
	function (content, mentions) {
		var c = hecrj$html_parser$Html$Parser$run(
			A3(
				...
				A3(
					...
					' !',
					'&#160;!',
					A3(elm_community$string_extra$String$Extra$replace, ' ?', '&#160;?', content))));
		if (c.$ === 'Ok') {
			var c_ = c.a;
			return A2(author$project$View$Formatter$toVirtualDom, mentions, c_);
		} else {
			return _List_Nil;
		}
	});
var author$project$View$Status$statusContent = F3(
	function (theme, content, mentions) {
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			A2(author$project$View$Formatter$formatContent, content, mentions));
	});
var author$project$View$Status$view = F2(
	function (theme, _n0) {
		var account = _n0.account;
		var content = _n0.content;
		var mentions = _n0.mentions;
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$Image$smallAccountImage(
							elm$core$Maybe$Just(account.avatar))
						])),
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							A2(author$project$View$Status$statusAccount, theme, account),
							A3(author$project$View$Status$statusContent, theme, content, mentions),
							author$project$View$Status$statusActionGroup(theme)
						]))
				]));
	});
var author$project$View$Status$viewTimeline = F2(
	function (theme, timeline) {
		return _List_fromArray(
			[
				function () {
				switch (timeline.$) {
					case 'NotAsked':
						return A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Initialising...')
								]));
					case 'Loading':
						return A2(
							rtfeldman$elm_css$Html$Styled$div,
					...
					case 'Failure':
						return A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Oups... something bad happens. We are sorry, but not perfect. Maybe try again?')
								]));
					default:
						var list = timeline.a;
						return elm$core$List$isEmpty(list) ? A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Nothing to show...')
								])) : A2(
							rtfeldman$elm_css$Html$Styled$div,
							_List_Nil,
							A2(
								elm$core$List$map,
								author$project$View$Status$view(theme),
								list));
				}
			}()
			]);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					author$project$View$Zone$mainArea,
					theme,
					A2(author$project$View$Status$viewTimeline, theme, timeline)),
					A2(
					author$project$View$Zone$aside,
					theme,
					A2(author$project$View$WhoToFollow$view, theme, client.account))
...
var author$project$Page$Home$view = F2(
	function (model, theme) {
		return {
			...
			kids: _List_fromArray(
				[
					A2(author$project$Page$Home$viewContent, theme, model)
				]),
			sidebar: _List_Nil,
			theme: theme,
			title: '🌎 ' + (model.title + ' / Tooter'),
...
var author$project$Page$Inbox$viewContent = F2(
	function (theme, _n0) {
		var client = _n0.client;
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('Notification...')
								]))
						])),
					A2(
					author$project$View$Zone$aside,
...
var author$project$Page$Inbox$view = F2(
	function (model, theme) {
		return {
			aside: _List_Nil,
			css: _List_fromArray(
			...
			kids: _List_fromArray(
				[
					A2(author$project$Page$Inbox$viewContent, theme, model)
				]),
			sidebar: _List_Nil,
			theme: theme,
			title: '🌎 ' + (model.title + ' / Tooter'),
...
var author$project$View$Zone$full = F2(
	function (_n0, content) {
		var layout = _n0.layout;
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Page$Lock$viewContent = F2(
	function (theme, model) {
		return A2(
			...
			_List_fromArray(
				[
					A2(
					author$project$View$Zone$full,
					theme,
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('Lock, because your timelines are not for everyone...')
						]))
				]));
	});
var author$project$Page$Lock$view = F2(
	function (model, theme) {
		return {
			aside: _List_Nil,
			css: _List_fromArray(
			...
			kids: _List_fromArray(
				[
					A2(author$project$Page$Lock$viewContent, theme, model)
				]),
			sidebar: _List_Nil,
			theme: theme,
			title: '🌎 ' + (model.title + ' / Tooter'),
...
var author$project$Page$Notification$viewContent = F2(
	function (theme, _n0) {
		var client = _n0.client;
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Page$Notification$view = F2(
	function (model, theme) {
		return {
			aside: _List_Nil,
			css: _List_fromArray(
			...
			kids: _List_fromArray(
				[
					A2(author$project$Page$Notification$viewContent, theme, model)
				]),
			sidebar: _List_Nil,
			theme: theme,
			title: '🌎 ' + (model.title + ' / Tooter'),
...
var author$project$Page$Problem$notFound = function (theme) {
	return _List_fromArray(
		[
			A2(
			rtfeldman$elm_css$Html$Styled$div,
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text('I cannot find this page!')
				]))
		]);
};
var author$project$Page$Search$viewContent = F2(
	function (theme, _n0) {
		var client = _n0.client;
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Page$Search$view = F2(
	function (model, theme) {
		return {
			aside: _List_Nil,
			css: _List_fromArray(
			...
			kids: _List_fromArray(
				[
					A2(author$project$Page$Search$viewContent, theme, model)
				]),
			sidebar: _List_Nil,
			theme: theme,
			title: '🌎 ' + (model.title + ' / Tooter'),
...
var author$project$Page$SignIn$viewFetching = function (theme) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('Fetching...')
					]))
			]));
};
var author$project$Theme$overrideCss = F2(
...
var author$project$Toolbar$linkWrapper = function (content) {
	return _List_fromArray(
		[
			A2(
			rtfeldman$elm_css$Html$Styled$div,
...
var rtfeldman$elm_css$Css$inherit = _Utils_update(
	...
	{value: 'inherit'});
var author$project$Toolbar$toolbarLinkStyle = function (theme) {
	return _List_fromArray(
		[
...
var author$project$Toolbar$inversedToolbarLink = F3(
	function (theme, url, content) {
		return A2(
			rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					A2(
					author$project$Theme$overrideCss,
					author$project$Toolbar$toolbarLinkStyle(theme),
					_List_fromArray(
						[
							rtfeldman$elm_css$Css$color(theme.colors.lightText),
							rtfeldman$elm_css$Css$backgroundColor(theme.colors.dark),
							rtfeldman$elm_css$Css$hover(
							_List_fromArray(
								[
									rtfeldman$elm_css$Css$backgroundColor(theme.colors.lightText)
								]))
						])),
					rtfeldman$elm_css$Html$Styled$Attributes$href(url)
				]),
			author$project$Toolbar$linkWrapper(content));
	});
var author$project$Toolbar$inversedIconLink = F4(
	function (theme, url, label, iconName) {
		return A3(
			author$project$Toolbar$inversedToolbarLink,
			theme,
			url,
			_List_fromArray(
				[
...
var author$project$Skeleton$headerWrapper = F3(
	function (segments, theme, _n0) {
		var logo = _n0.logo;
		var navigation = _n0.navigation;
		var ni = author$project$Toolbar$inversedIconLink(theme);
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$id('header'),
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							rtfeldman$elm_css$Css$displayFlex,
							...
							rtfeldman$elm_css$Css$px(0)),
							rtfeldman$elm_css$Css$backgroundColor(theme.colors.mediumBackground),
							rtfeldman$elm_css$Css$lineHeight(
							rtfeldman$elm_css$Css$rem(3.6)),
...
var author$project$Skeleton$viewLogo = function (theme) {
	return A2(
		rtfeldman$elm_css$Html$Styled$a,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Css$color(theme.colors.lightText),
						rtfeldman$elm_css$Css$textDecoration(rtfeldman$elm_css$Css$none),
						rtfeldman$elm_css$Css$marginLeft(theme.layout.defaultMargin)
					]))
			]),
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$text('Tooter')
			]));
};
var author$project$Skeleton$viewMinimalHeader = F2(
	function (segments, theme) {
		return A3(
			author$project$Skeleton$headerWrapper,
			segments,
			theme,
			{
				logo: _List_fromArray(
					[
						author$project$Skeleton$viewLogo(theme)
					]),
				navigation: _List_fromArray(
					[
						A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										rtfeldman$elm_css$Css$rem(1)),
										rtfeldman$elm_css$Css$fontSize(
										rtfeldman$elm_css$Css$rem(1.35))
									]))
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('A web client for your favorits Mastodon instances')
							]))
					])
			});
	});
var author$project$Skeleton$viewWarning = function (warning) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$id('warnings')
			]),
		_List_Nil);
};
...
var author$project$Skeleton$minimalView = function (details) {
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(rtfeldman$elm_css$Html$Styled$Lazy$lazy, author$project$Skeleton$viewWarning, details.warning),
						A2(author$project$Skeleton$viewMinimalHeader, details.header, details.theme),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
						A2(
							elm$core$List$cons,
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$css(details.css)
								])),
						details.kids)
					]))
			]),
...
var author$project$Skeleton$viewFooter = function (theme) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$id('footer'),
				rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$fontSize(
		...
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$text('All code for this site is open source and written in Elm. '),
				A2(
				rtfeldman$elm_css$Html$Styled$a,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$class('grey-link'),
						rtfeldman$elm_css$Html$Styled$Attributes$href('https://github.com/dfeyer/tooter')
					]),
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('Check it out')
					])),
				rtfeldman$elm_css$Html$Styled$text(' © 2018 ttree agency - we make internet better for you')
			]));
};
...
var author$project$Toolbar$circularToolbarLink = F3(
	function (theme, url, content) {
		return A2(
			rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$borderRadius(
							rtfeldman$elm_css$Css$pct(50)),
							rtfeldman$elm_css$Css$width(theme.layout.navigationHeight),
							rtfeldman$elm_css$Css$height(theme.layout.navigationHeight),
							rtfeldman$elm_css$Css$textAlign(rtfeldman$elm_css$Css$center),
							rtfeldman$elm_css$Css$transforms(
							_List_fromArray(
								[
									rtfeldman$elm_css$Css$scale(0.7)
								])),
							rtfeldman$elm_css$Css$hover(
							_List_fromArray(
								[
...
var author$project$Toolbar$circularIconLink = F4(
	function (theme, url, label, iconName) {
		return A3(
			author$project$Toolbar$circularToolbarLink,
			theme,
			url,
			_List_fromArray(
				[
...
var author$project$Toolbar$toolbarLink = F3(
	function (theme, url, content) {
		return A2(
			rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
...
var author$project$Toolbar$iconLink = F4(
	function (theme, url, label, iconName) {
		return A3(
			author$project$Toolbar$toolbarLink,
			theme,
			url,
			_List_fromArray(
				[
...
var author$project$Toolbar$majorToolbarLink = F3(
	function (theme, url, content) {
		return A2(
			rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Css$color(theme.colors.major),
...
var author$project$Toolbar$majorIconLink = F4(
	function (theme, url, label, iconName) {
		return A3(
			author$project$Toolbar$majorToolbarLink,
			theme,
			url,
			_List_fromArray(
				[
...
var author$project$Skeleton$viewAdvancedNavigation = function (theme) {
	var nm = author$project$Toolbar$majorIconLink(theme);
	var nc = author$project$Toolbar$circularIconLink(theme);
	var n = author$project$Toolbar$iconLink(theme);
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A3(n, '/inbox', 'Direct Messages', 'email-unread'),
				A3(nm, '/search', 'Search', 'search'),
				A3(nc, '/create', 'Create', 'flash'),
				A3(n, '/lock', 'Lock', 'android-lock')
			]));
};
...
var author$project$Icon$iconWithLabel = F2(
	function (name, label) {
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_Nil,
...
var author$project$Toolbar$navigationLink = F4(
	function (theme, url, label, iconName) {
		return A3(
			author$project$Toolbar$toolbarLink,
			theme,
			...
			_List_fromArray(
				[
					A2(author$project$Icon$iconWithLabel, iconName, label)
				]));
	});
var author$project$Skeleton$viewTimelineNavigation = function (theme) {
	var n = author$project$Toolbar$navigationLink(theme);
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A3(n, '/', 'Home', 'home'),
				A3(n, '/local', 'Local', 'paper-airplane'),
				A3(n, '/federated', 'Federated', 'planet'),
				A3(n, '/favorites', 'Favorites', 'star'),
				A3(n, '/notifications', 'Notifications', 'ios-bell')
			]));
};
			...
			theme,
			{
				logo: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3(ni, '/panel', 'Menu', 'menu')
							]))
					]),
				navigation: _List_fromArray(
					[
						author$project$Skeleton$viewTimelineNavigation(theme),
						author$project$Skeleton$viewAdvancedNavigation(theme)
					])
			});
	});
						...
						[
							...
							_List_fromArray(
								[
									...
									rtfeldman$elm_css$Css$maxWidth(
									rtfeldman$elm_css$Css$pct(75)),
									rtfeldman$elm_css$Css$backgroundColor(details.theme.colors.appBackground)
								]))
						]),
					_List_fromArray(
						[
							A2(rtfeldman$elm_css$Html$Styled$Lazy$lazy, author$project$Skeleton$viewWarning, details.warning),
							A2(author$project$Skeleton$viewHeader, details.header, details.theme),
							A2(
							...
							A2(
								...
								details.kids)),
							author$project$Skeleton$viewFooter(details.theme)
						]))
				]),
			title: details.title
		};
...
var author$project$Main$view = function (model) {
	...
	switch (_n0.$) {
		case 'NotFound':
			return author$project$Document$toUnstyledDocument(
				author$project$Skeleton$minimalView(
					{
						aside: _List_Nil,
						css: _List_Nil,
						header: _List_Nil,
						kids: author$project$Page$Problem$notFound(theme),
						sidebar: _List_Nil,
						theme: theme,
						title: 'Not Found',
						warning: author$project$Skeleton$NoProblems
				...
				author$project$Skeleton$minimalView(
					{
						...
						kids: _List_fromArray(
							[
								A2(author$project$Main$signInView, theme, auth)
							]),
						sidebar: _List_Nil,
						theme: theme,
				...
				author$project$Skeleton$minimalView(
					{
						...
						kids: _List_fromArray(
							[
								author$project$Page$SignIn$viewFetching(theme)
							]),
						sidebar: _List_Nil,
						theme: theme,
		...
		case 'Create':
			...
			return author$project$Document$toUnstyledDocument(
				A2(
					...
					A2(author$project$Page$Create$view, create, theme)));
		case 'Home':
			var home = _n0.a;
			return author$project$Document$toUnstyledDocument(
				A2(
					...
					A2(author$project$Page$Home$view, home, theme)));
		case 'Inbox':
			var inbox = _n0.a;
			return author$project$Document$toUnstyledDocument(
				A2(
					...
					A2(author$project$Page$Inbox$view, inbox, theme)));
		case 'Lock':
			var lock = _n0.a;
			return author$project$Document$toUnstyledDocument(
				A2(
					author$project$Skeleton$view,
					author$project$Main$LockMsg,
					A2(author$project$Page$Lock$view, lock, theme)));
		case 'Notification':
			var notification = _n0.a;
			return author$project$Document$toUnstyledDocument(
				A2(
					...
					A2(author$project$Page$Notification$view, notification, theme)));
		default:
			var search = _n0.a;
			return author$project$Document$toUnstyledDocument(
				A2(
					...
					A2(author$project$Page$Search$view, search, theme)));
	}
};
			...
			return A2(
				...
				function (clients) {
					return elm$json$Json$Decode$succeed(
						{clients: clients, randomBytes: randomBytes});
				},
				A2(elm$json$Json$Decode$field, 'clients', elm$json$Json$Decode$string));
		},
		A2(elm$json$Json$Decode$field, 'randomBytes', elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Type.Account":{"args":[],"type":"{ acct : String.String, avatar : String.String, created_at : Time.Posix, display_name : String.String, followers_count : Basics.Int, following_count : Basics.Int, header : String.String, id : Type.AccountId, locked : Basics.Bool, note : String.String, statuses_count : Basics.Int, url : String.String, username : String.String }"},"Type.AccountId":{"args":[],"type":"String.String"},"Type.OAuthConfiguration":{"args":[],"type":"{ authorizationEndpoint : Url.Url, tokenEndpoint : Url.Url, accountEndpoint : Url.Url, clientId : String.String, clientSecret : String.String, scope : List.List String.String, accountDecoder : Json.Decode.Decoder Type.Account }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"OAuth.AuthorizationCode.AuthenticationSuccess":{"args":[],"type":"{ token : OAuth.Token, refreshToken : Maybe.Maybe OAuth.Token, expiresIn : Maybe.Maybe Basics.Int, scope : List.List String.String }"},"Type.Application":{"args":[],"type":"{ name : String.String, website : Maybe.Maybe String.String }"},"Type.Attachment":{"args":[],"type":"{ id : String.String, type_ : String.String, url : String.String, remote_url : String.String, preview_url : String.String, text_url : Maybe.Maybe String.String }"},"Type.Mention":{"args":[],"type":"{ id : Type.AccountId, url : String.String, username : String.String, acct : String.String }"},"Type.Status":{"args":[],"type":"{ account : Type.Account, application : Maybe.Maybe Type.Application, content : String.String, created_at : String.String, favourited : Maybe.Maybe Basics.Bool, favourites_count : Basics.Int, id : Type.StatusId, in_reply_to_account_id : Maybe.Maybe String.String, in_reply_to_id : Maybe.Maybe Type.StatusId, media_attachments : List.List Type.Attachment, mentions : List.List Type.Mention, reblog : Maybe.Maybe Type.Reblog, reblogged : Maybe.Maybe Basics.Bool, reblogs_count : Basics.Int, sensitive : Maybe.Maybe Basics.Bool, spoiler_text : String.String, tags : List.List Type.Tag, uri : String.String, url : Maybe.Maybe String.String, visibility : String.String }"},"Type.Tag":{"args":[],"type":"{ name : String.String, url : String.String }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"},"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"CreateMsg":["Page.Create.Msg"],"HomeMsg":["Page.Home.Msg"],"InboxMsg":["Page.Inbox.Msg"],"LockMsg":["Page.Lock.Msg"],"NotificationMsg":["Page.Notification.Msg"],"SearchMsg":["Page.Search.Msg"],"SetInstance":["String.String"],"SignInRequested":["Type.OAuthConfiguration"],"SignOutRequested":[],"GotAccessToken":["Type.OAuthConfiguration","Result.Result Http.Error OAuth.AuthorizationCode.AuthenticationSuccess"],"GotUserInfo":["Result.Result Http.Error Type.Account"]}},"Page.Create.Msg":{"args":[],"tags":{"NoOp":[]}},"Page.Home.Msg":{"args":[],"tags":{"NoOp":[],"Navigate":["String.String"],"TimelineUpdated":["RemoteData.WebData (List.List Type.Status)"]}},"Page.Inbox.Msg":{"args":[],"tags":{"NoOp":[]}},"Page.Lock.Msg":{"args":[],"tags":{"NoOp":[]}},"Page.Notification.Msg":{"args":[],"tags":{"NoOp":[]}},"Page.Search.Msg":{"args":[],"tags":{"NoOp":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Json.Decode.Decoder":{"args":["a"],"tags":{"Decoder":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"OAuth.Token":{"args":[],"tags":{"Bearer":["String.String"]}},"Type.Reblog":{"args":[],"tags":{"Reblog":["Type.Status"]}},"Type.StatusId":{"args":[],"tags":{"StatusId":["String.String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));